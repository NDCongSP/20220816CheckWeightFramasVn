...
namespace WeightChecking
{
    public partial class frmScaleNewUI : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmScaleNewUI()
        {
            ...
            titleText.Text = "fVN - SSFG Station";
                        ...
                        if (res != null)
                        {
                            ...
                            if (_scanData.AveWeight1Prs != 0)
                            {
                                ...
                                if (_scanData.DeviationPairs == 0)
                                {
                                    ...
                                    {
                                        //MessageBox.Show($"This carton has already been scanned and its weight recorded as OK; it is not allowed to be weighed again."
